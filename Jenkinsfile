...
agent any
  ...
  post{
	success{
slackSend channel: 'U01D689C92A', color: 'good', message: [Miguel Vera Miranda] + 'Ejecución exitosaa', teamDomain: 'dipdevopsusach2020', tokenCredentialId: 'f7b6dd93-5a8e-4493-9428-37004efbe394'
	}
